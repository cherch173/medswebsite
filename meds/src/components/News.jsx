    ...
    return (
        <div>
            <div className="card">
                ...
                <br />
                <iframe className="spotifyPlayer" src="https://open.spotify.com/embed/artist/1ZS6JkgfS2sUjAnP9SrK0d?utm_source=generator&theme=0;" width="100%" height="352" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; fullscreen; picture-in-picture" robustness="10" loading="lazy"></iframe>
            </div>
