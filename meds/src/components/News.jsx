    ...
    return (
        <div>
            ...
            <div className="newsCard">
                ...
                <p>Jan 5, 2023</p>
                <br />
                <Link className="" target="_blank" to="https://open.spotify.com/artist/1ZS6JkgfS2sUjAnP9SrK0d?si=B875lvjcSL2QL1IF07YzQg">
                ...
                <div className="socialNav">
                    ...
                    <Link className="navA" to="http://medsofficial.bandcamp.com" target="_blank">
