        ...
        <div>
            ...
            <div className="newsCard">
                ...
                <div className="imageCard">
                    ...
                    <Link className="epImage" target="_blank" to="https://open.spotify.com/artist/1ZS6JkgfS2sUjAnP9SrK0d?si=iGKmB4FJS1K1MzAMCs9-wA">
                        <img className="releaseImage" src={thirtyCover} alt="meds_nightVol1_image" />
                    </Link>
                </div>
                <p>
                    At last, we can close our first chapter together.
                </p>
                <p>
                    ...
                    and we'd like to acknowledge and recognize them for their perserverence through adversity.
                    There are numerous difficulities involved in healing and progress is a spectral process.
                    We love you and see you. Thank you for walking this path alongside us.
                    <br />
                    <br />
